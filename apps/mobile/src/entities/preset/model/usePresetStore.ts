...
export const DEFAULT_FILM_PAYLOAD: FilmPresetPayload = {
  ...
  halationIntensity: DEFAULT_HALATION_INTENSITY,
  halationEnabled: DEFAULT_HALATION_ENABLED,
  halationThreshold: DEFAULT_HALATION_THRESHOLD,
  bloomThreshold: DEFAULT_BLOOM_THRESHOLD,
  chromaBleed: DEFAULT_CHROMA_BLEED,
};
