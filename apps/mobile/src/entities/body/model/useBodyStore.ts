...
export const useBodyStore = create<BodyStore>((set, get) => ({
  ...
  setEvAuto: (value) => {
    ...
    notifyBodyStoreListener('evAuto');
  },
  setEv: (value) => {
  ...
  setFps: (value) => {
    get().fps.value = value;
    notifyBodyStoreListener('fps');
  },
  setHwFps: (value) => {
    get().hwFps.value = value;
    notifyBodyStoreListener('hwFps');
  },
  setResolution: (value) => {
    get().resolution.value = value;
    notifyBodyStoreListener('resolution');
  },
  // @@GEN_SETTERS_END@@
