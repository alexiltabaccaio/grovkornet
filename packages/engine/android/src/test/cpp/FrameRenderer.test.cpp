...
TEST(FrameRendererTest, FullRenderLifecycle_Success) {
    ...
    params.bloomIntensity = 0.5f; // Test bloom branch
    params.panelY = 0.8f;         // Test panel Y branch
    ...
    bool res1 = FrameRenderer::renderOffscreenFrame(gEngine, pixelsIn.data(), pixelsOut.data(), params);
    ...
    bool res2 = FrameRenderer::renderOffscreenFrame(gEngine, pixelsIn.data(), pixelsOut.data(), params);
    ...
    bool res3 = FrameRenderer::renderHardwareBufferFrame(gEngine, ahb, params);
    ...
    bool res4 = FrameRenderer::renderHardwareBufferFrame(gEngine, ahb, params);
    ...
    bool resLive1 = FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, false, true, actualFps, stampedFps, fpsUpdated);
    ...
    bool resLivePacedOut = FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, false, true, actualFps, stampedFps, fpsUpdated);
    ...
    bool resLive2 = FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, true, true, actualFps, stampedFps, fpsUpdated);
    ...
    params.bloomIntensity = 0.0f;
    bool resLive3 = FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, false, false, actualFps, stampedFps, fpsUpdated);
    ...
    EXPECT_FALSE(FrameRenderer::renderOffscreenFrame(gEngine, nullptr, pixelsOut.data(), params));
    EXPECT_FALSE(FrameRenderer::renderOffscreenFrame(gEngine, pixelsIn.data(), nullptr, params));

    // 2. Hardware buffer render validation path
    EXPECT_FALSE(FrameRenderer::renderHardwareBufferFrame(gEngine, nullptr, params));

    // 3. Live frame render validation paths
    EXPECT_FALSE(FrameRenderer::renderLiveFrame(gEngine, params, nullptr, 640, 480, 640, 480, false, true, actualFps, stampedFps, fpsUpdated));
    
    filament::SwapChain* tempLiveSwapChain = gEngine.liveSwapChain;
    gEngine.liveSwapChain = nullptr;
    EXPECT_FALSE(FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, false, true, actualFps, stampedFps, fpsUpdated));
    ...
    gEngine.timingController.reset();
    bool resViewportFallback = FrameRenderer::renderLiveFrame(gEngine, params, mockUv, 640, 480, 640, 480, false, true, actualFps, stampedFps, fpsUpdated);
